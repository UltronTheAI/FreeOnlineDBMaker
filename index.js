      ...
      <div class="mt-10">
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          <div class="relative">
            ...
            <dd class="mt-2 ml-16 text-base text-gray-500">You can create your own database in this web app, after clicking Get Started then you will get a code that is database access code, you can use this code to read, write and delete data in your db, you can share this to anyone who you know But don't share this code with stranger because they can access your database, if they have access to your database and they try to do illegal things in your database then it is your responsibility because you had created database and you are the head of that database, to solve the problem you can use hidden server side backend, if you try to do illegal things in database then it is your responsibility.</dd>
          </div>
            ...
            <div class="mt-4">
                <div>
                    <label class="block" for="email">Name<label>
                            <input type="text" placeholder="Name" id="na"
                                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                            <span class="text-xs tracking-wide text-red-600">Email field is required</span>
                </div>
                <div class="flex items-baseline justify-between">
                    <button class="px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900" onclick="socket.emit('agree', document.getElementById('na').value)">I Agree</button>
...
<script>
  var u = 'https://free-online-db-maker.herokuapp.com/GetUid/?';
